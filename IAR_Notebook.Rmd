...
top_3_by_region_plot <- ggplot(top_3_by_region, aes(x = standardized_name, y = name_count, fill = standardized_name)) +
...
top_3_orgs_by_reg_region_plot <- ggplot(top_3_orgs_by_reg_region, aes(x = standardized_name, y = total_registration_count, fill = standardized_name)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +  
  facet_grid(~ employment_region) +  
  labs(
